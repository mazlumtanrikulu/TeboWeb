...
const findItem = (serviceId, dataId) => {
  return serviceData.find((sd) => sd.id.toString() === serviceId).items.find((item) => item.id.toString() === dataId).item
}

export default function CompanyHistory() {
  const { service, detail } = useParams()
  const item = findItem(service, detail)
  const data = serviceData.find((sd) => sd.id.toString() === service)
  return (
    <>
